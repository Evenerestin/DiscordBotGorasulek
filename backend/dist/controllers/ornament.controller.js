...
exports.getOrnaments = exports.saveOrnament = void 0;
const fs_extra_1 = __importDefault(require("fs-extra"));
const path_1 = __importDefault(require("path"));
const ornament_service_1 = require("../services/ornament.service");
const dataDir = path_1.default.join(__dirname, "../../../data");
const ornamentsPath = path_1.default.join(dataDir, "ornaments.json");
const saveOrnament = (req, res) => {
    ...
    fs_extra_1.default.readJson(ornamentsPath)
        .then((ornaments) => {
        ...
        return (0, ornament_service_1.saveOrnamentData)(username, sessionId, ornamentData, newId);
    })
        .then(() => {
...
exports.saveOrnament = saveOrnament;
const getOrnaments = (_req, res) => {
    (0, ornament_service_1.getOrnamentsData)()
        .then((ornaments) => {
...
exports.getOrnaments = getOrnaments;
